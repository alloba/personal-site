...
```
cd existing_repo
git remote add origin https://gitlab.com/alloba/personal-landing-site.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/alloba/personal-landing-site/-/settings/integrations)
